    ...
    <BasicTable @register="registerTable">
      ...
      <template #action="{ record }">
        <TableAction
          :actions="[
            {
              label: t('lamp.tenant.datasourceConfig.testConnection'),
...
<script lang="ts">
  ...
  import { page, remove, testConnect } from '/@/api/lamp/tenant/datasourceConfig';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [registerTable, { reload }] = useTable({
        title: t('lamp.tenant.datasourceConfig.table.title'),
        api: page,
        columns,
        formConfig: {
          labelWidth: 120,
