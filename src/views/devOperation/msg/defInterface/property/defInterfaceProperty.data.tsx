...
export const formItems = (): any[] => {
  return [
    {
      title: t('devOperation.msg.defInterfaceProperty.name'),
      field: 'name',
      itemRender: { name: '$input', props: { placeholder: '请输入' } },
    },
    {
      title: t('devOperation.msg.defInterfaceProperty.key'),
      field: 'key',
      itemRender: { name: '$input', props: { placeholder: '请输入' } },
    },
    {
      title: t('devOperation.msg.defInterfaceProperty.value'),
      field: 'value',
      itemRender: { name: '$input', props: { placeholder: '请输入' } },
    },
    {
...
export const columns = (): VxeGridPropTypes.Columns => {
  return [
    ...
    {
      field: 'remarks',
      title: t('devOperation.msg.defInterfaceProperty.remarks'),
      editRender: { name: '$input', attrs: { placeholder: '请输入' } },
    },
    {
