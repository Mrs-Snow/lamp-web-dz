...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/basic/msg/extendInterfaceLogging';
  import { getValidateRules } from '/@/api/lamp/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './extendInterfaceLogging.data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [registerForm, { setFieldsValue, resetFields, updateSchema, validate, resetSchema }] =
        useForm({
          name: 'ExtendInterfaceLoggingEdit',
          labelWidth: 100,
