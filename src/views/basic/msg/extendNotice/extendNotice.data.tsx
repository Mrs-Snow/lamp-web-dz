...
export const columns = (): BasicColumn[] => {
  return [
    {
      title: t('basic.msg.extendNotice.bizId'),
      dataIndex: 'bizId',
    },
    {
      title: t('basic.msg.extendNotice.bizType'),
      dataIndex: 'bizType',
    },
    {
      title: t('basic.msg.extendNotice.recipientId'),
    ...
    {
      title: t('basic.msg.extendNotice.url'),
      dataIndex: 'url',
    },
    {
      title: t('basic.msg.extendNotice.target'),
      dataIndex: ['echoMap', 'target'],
      key: 'target',
    },
    {
      title: t('basic.msg.extendNotice.autoRead'),
      dataIndex: 'autoRead',
    },
    {
      title: t('basic.msg.extendNotice.handleTime'),
      dataIndex: 'handleTime',
    },
    {
      title: t('basic.msg.extendNotice.readTime'),
      dataIndex: 'readTime',
    },
    {
    ...
    {
      title: t('basic.msg.extendNotice.isHandle'),
      dataIndex: 'isHandle',
    },
    {
      title: t('basic.msg.extendNotice.createdOrgId'),
