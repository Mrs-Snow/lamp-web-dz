...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/basic/msg/extendMsgRecipient';
  import { getValidateRules } from '/@/api/lamp/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './extendMsgRecipient.data';
