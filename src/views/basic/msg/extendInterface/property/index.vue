...
<script lang="ts">
  ...
  import { columns, customFormSchemaRules, formItems } from './extendInterfaceProperty.data';
  import { Api, page as pageRequest, batchSave } from '/@/api/basic/msg/extendInterfaceProperty';
