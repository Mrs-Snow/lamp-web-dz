...
<script lang="ts">
  ...
  import { Api, save, update } from '/@/api/basic/msg/extendInterfaceProperty';
  import { getValidateRules } from '/@/api/lamp/common/formValidateService';
  import { customFormSchemaRules, editFormSchema } from './extendInterfaceProperty.data';
  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const [registerForm, { setFieldsValue, resetFields, updateSchema, validate, resetSchema }] =
        useForm({
          name: 'ExtendInterfacePropertyEdit',
          labelWidth: 100,
